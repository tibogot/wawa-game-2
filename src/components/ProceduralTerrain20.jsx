...
function createTerrainData({
  ...
  const overflowSize = (segments + 1) * (segments + 1);
  ...
  for (let iz = 0; iz < segments; iz++) {
    for (let ix = 0; ix < segments; ix++) {
      ...
      const neighbourZ = overflowElevations[overflowIndex + segments + 1];
...
export const ProceduralTerrain20 = forwardRef(
  (
    {
      size = 1024,
      subdivisions = 120,
...
ProceduralTerrain20.displayName = "ProceduralTerrain20";
