...
export default function useClaudeGrassQuickControls7() {
  const controls = useControls("🌿 FOLIAGE", {
    claudeGrassQuick7: folder(
      {
        // Master toggle
        enabled: {
          value: false,
          label: "🌿 Enable Claude Grass Quick 7",
        },
        ...
        advanced: folder(
          {
            ...
            minSkyBlend: {
              ...
              max: 0.85,
              step: 0.01,
              label: "Min Sky Blend (Near Normal UP)",
            },
          },
          { collapsed: true }
        ),
  ...
  // Return flat object for Map1-style usage: controls.enabled, controls.windEnabled, etc.
  const raw = controls.claudeGrassQuick7 ?? controls;
  return {
    ...raw,
    ...(raw.wind || {}),
    ...(raw.colors || {}),
