...
export default function useClaudeGrassQuick4Controls() {
  const controls = useControls("🌿 FOLIAGE", {
    claudeGrassQuick4: folder(
      {
        // Master toggle
        enabled: {
          value: false,
          label: "🌿 Enable Claude Grass Quick 4",
        },
        ...
        colors: folder(
          {
            ...
            baseColor2: {
              value: "#051303", // FOR DEBUG: Same as baseColor1 - no variation
            ...
            tipColor2: {
              value: "#a6cc40", // FOR DEBUG: Same as tipColor1 - no variation
        ...
        advanced: folder(
          {
            ...
            grassMiddleBrightnessMin: {
              value: 1.0, // FOR DEBUG: Same as max - no brightness variation
              min: 0.0,
              max: 1.0,
              step: 0.01,
        ...
        backscatter: folder(
          {
            backscatterEnabled: {
              value: false, // FOR DEBUG: Disabled to eliminate lighting variation
