...
// Main component
export default function ClaudeGrassQuick7({
    ...
    useMemo(() => {
      ...
      const createMaterial = (segments, vertices) => {
        const mat = new THREE.MeshPhongMaterial({
          ...
          specular: 0x000000, // Disable built-in Phong specular (custom specular is handled in shader)
          shininess: 0,
  ...
  const updateMaterialUniforms = (mat) => {
    ...
    uf.playerInteractionHeightThreshold.value =
