...
export const TornadoLeaves2: React.FC<FloatingLeavesProps> = ({
  ...
  // Internal controls
  const {
    tornadoLeaves2Enabled: enabled,
    tornadoLeaves2Count: count,
    tornadoLeaves2Radius: tornadoRadius,
    tornadoLeaves2Height: tornadoHeight,
    tornadoLeaves2RotationSpeed: tornadoRotationSpeed,
    tornadoLeaves2SpiralSpeed: spiralSpeed,
    tornadoLeaves2SpiralSpread: spiralSpread,
    tornadoLeaves2EnableViewThickening: enableViewThickening,
    tornadoLeaves2ViewThickenStrength: viewThickenStrength,
    tornadoLeaves2LeafSize: leafSize,
    tornadoLeaves2Gravity: gravity,
    tornadoLeaves2UseTexture: useTexture,
  } = useControls("🌿 FOLIAGE", {
    "🌪️ Tornado Leaves 2": folder(
      {
        tornadoLeaves2Enabled: {
        ...
        tornadoLeaves2EnableViewThickening: {
          value: true,
          label: "Enable View Thickening",
        },
        tornadoLeaves2ViewThickenStrength: {
          value: 0.3,
